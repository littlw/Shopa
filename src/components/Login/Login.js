...
import { setRoute, loadUser, adminSignIn } from '../../Actions/actions';
        ...
        <main className="pa4 black-80">
          <div className="measure">
            ...
            <div className="lh-copy mt3">
              <NavLink to={'/register'}  className="f6 link  black  pointer">Don't have an account, then let's Register</NavLink>
            </div>
          </div>
        </main>
      </article>
